...
<head>
  ...
  <title>🥀🥀𝑻𝑯𝑬 𝑳𝑬𝑮𝑬𝑵𝑫 𝑷𝑹𝑰𝑵𝑪𝑬 𝑿𝑫🥀🥀</title>
...
<body>
  <header class="header mt-4">
   <h1 class="mb-3" style="color: #00ff00;">🥀🥀𝑻𝑯𝑬 𝑳𝑬𝑮𝑬𝑵𝑫 𝑷𝑹𝑰𝑵𝑪𝑬 𝑿𝑫🥀🥀</h1>
   <h2 style="color: #ff4500;">𒆜𝒪𝒲𝒩𝐸𝑅𒆜 ➨ 🥀🥀𝑷𝑹𝑰𝑵𝑪𝑬 𝑿𝑫👑✌</h2>
  </header>
...
<p style="color: #000000;">Created with ♥ By ☞ <span style="color: #ff1493;">🥀🥀𝑻𝑯𝑬 𝑳𝑬𝑮𝑬𝑵𝑫 𝑷𝑹𝑰𝑵𝑪𝑬 𝑿𝑫🥀🥀</span> 😊💔</p>
    ...
    ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴇʙᴏᴏᴋ
      ...
      <a href="https://wa.me/+997543864229" class="whatsapp-link" style="color: #006400; font-size: 18px; text-decoration: none;">
